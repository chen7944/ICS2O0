/*
  Description: Processing Assignment 1 -- Gwent: The Witcher Card Game | Art by Wlop
  Author: Andy Chen
...
//Total Lines: 33687
//After Line 73 are 16800 RGBValues (Plus 16800 Empty Lines), do not bother looking
...
// Input -- Line 62
// Output -- Line 29
// Custom Variables -- Line 21
// Built-In Variables -- Line 25
// Conditional Statements (If) -- Line 56
// Image -- Line 28
...
void setup() {
  size(1007, 594);
  background(0);
  jpg = loadImage("G:\\MyFirstProgram\\Chen_A_10_CompSci_PA1\\WlopWitcher.jpg");
  println("Andy Chen (627944)'s Processing Assignment 1 -- Witcher");
}
